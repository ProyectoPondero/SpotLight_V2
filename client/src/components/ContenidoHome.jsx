                ...
                initialPublications.map((publication, index) => (
                    ...
                    <article key={index} className="border border-gray-300 dark:border-gray-700 rounded-lg p-4 mb-4 bg-white dark:bg-gray-800 shadow-md">
                        ...
                        <form action="" className='p-2'>
                            ...
                            <textarea name="" placeholder='Qué opinas?...' className='w-full h-16 mt-2 rounded border border-gray-300 p-2' id=""></textarea>

                            <div>
                            <button className='p-2 rounded bg-red-500 hover:bg-red-400 text-white'>Comentar</button>
                            </div>
                        </form>
                    </article>
                    </>
