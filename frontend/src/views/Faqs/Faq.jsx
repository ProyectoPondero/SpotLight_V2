            ...
            <div className="flex justify-center">
                <main className="bg-slate-200 dark:bg-gray-600 w-screen min-h-screen">
                    <div className='mt-24 py-4 bg-slate-200 dark:bg-gray-600 min-h-screen'>
                        ...
                        <div className=' px-10 flex flex-row justify-cente p-4'>
                            <div className='w-auto lg:grid grid-cols-2 gap-8 sm:flex sm:flex-col p-4'>
                                <details name='faq' className='mt-4 cursor-pointer' onClick={() => mostrarContenido(1)}>
                                    <summary className='shadow-sm font-bold bg-white text-center rounded-md p-2 flex justify-center items-center h-full hover:bg-gray-100 '>¿Cómo puedo cambiar la información de mi perfíl?</summary>
                                </details>
                                <details name='faq' className='mt-4 cursor-pointer' onClick={() => mostrarContenido(2)}>
                                    <summary className='shadow-sm font-bold bg-white text-center rounded-md p-2 flex justify-center items-center  h-full hover:bg-gray-100'>¿Cómo me puedo contactar con otro usuario?</summary>
                                </details>
                                <details name='faq' className='mt-4 cursor-pointer' onClick={() => mostrarContenido(3)}>
                                    <summary className='shadow-sm font-bold bg-white text-center rounded-md p-2 flex justify-center items-center  h-full hover:bg-gray-100'>¿Cómo puedo crear una convocatoria?</summary>
                                </details>
                                <details name='faq' className='mt-4 cursor-pointer' onClick={() => mostrarContenido(4)}>
                                    <summary className='shadow-sm font-bold bg-white text-center rounded-md p-2 flex justify-center items-center  h-full hover:bg-gray-100'>¿Cómo puedo reportar un problema?</summary>
                                </details>
                                <details name='faq' className='mt-4 cursor-pointer' onClick={() => mostrarContenido(5)}>
                                    <summary className='shadow-sm font-bold bg-white text-center rounded-md p-2 flex justify-center items-center  h-full hover:bg-gray-100'>¿Cómo puedo cambiar mi contraseña?</summary>
                                </details>
                                <details name='faq' className='mt-4 cursor-pointer' onClick={() => mostrarContenido(6)}>
                                    <summary className='shadow-sm font-bold bg-white text-center rounded-md p-2 flex justify-center items-cente h-full hover:bg-gray-100'>¿Cómo puedo darme de baja de la plataforma?</summary>
                                </details>
                            </div>

                            <div className='w-3/4 ml-1 p-4 rounded bg-lime-50 shadow-md'>
                        ...
                        <p className='w-full px-2 mt-8 text-center dark:text-white '>Si deseas saber algo más puedes dirigirte al <Link className='text-blue-500 hover:underline ' to="/support">soporte</Link> y los administradores te ayudaran con tus dudas. </p>
                    </div >
                </main >
            </div >
            <Footer />
