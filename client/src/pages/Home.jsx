...
import FormUploadfile from '../components/FormUpload.jsx'

export const Home = () => {
  return (
    <>
      <div className='mt-24 p-3 grid grid-cols-6 w-full px-6'>
        <div className='flex hidden sm:block min-h-screen shadow-2xl justify-center dark: dark:bg-gray-900 rounded'>
